...
public:
	...
	std::shared_ptr<foreign_function> make_callable(void* make_callable_context, const std::vector<metaffi_type_with_alias>& params_types, const std::vector<metaffi_type_with_alias>& retval_types);
